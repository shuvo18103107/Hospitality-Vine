...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); //now we insert this markup on the body ,afterbegin means body er vitor first e

  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); //ekhn 5 sec por alert ta hide korbo 
...
var userPassForm = document.querySelector('.form-user-password'); // Display map 
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn--save-data').textContent = 'Updating...⌛'; //form element create korbo for uploading photos,name,email

              form = new FormData(); //for uploading photo we do like form way other wise simple we can pass the obj of selected field value

              form.append('name', document.getElementById('name').value);
              form.append('email', document.getElementById('email').value);
              form.append('photo', document.getElementById('photo').files[0]);
              console.log(form); // const email = document.getElementById('email').val )
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; //we want to clear the field after updating the password
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14103" + '/');
