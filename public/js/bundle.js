      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            msg = _context.t0.response.data.message; // if (err.response.data.message.includes('User validation failed: passwordConfirm')) msg = 'Your passwords does not match!';
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, user, room) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", (0, _alert.showAlert)('error', "Review create Failed!"));
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data === '') (0, _alert.showAlert)('success', 'Review deleted successfully!');
            _context2.next = 10;
            break;
...
var editReview = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(token, data) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/reviews/".concat(token),
              data: data
            });
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', "wait untill it process");
  ...
  return function editReview(_x6, _x7) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'A Password Reset Token is Sent to Your Email📧');
              window.setTimeout(function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            //now check we get the data back successfully or not
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'your Password is changed. Welcome back to the application 🎉');
              window.setTimeout(function () {
                //load another page(home page) we use location.assign
                location.assign('/');
              }, 1500);
...
var stripe = Stripe('pk_test_51KNu7cHahdodWJaRU6Npk27vb5wTrXMxynONTLCMi7TS1fmnRx4RWMYE27Dbm7FRdhgrYvh7wjejagastQhBluBY00JLR6q59w');

var bookRoom = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/bookings/checkout-session/".concat(roomID)
            });
...
var forgotSubmit = document.querySelector('.forgotSubmit');
var ResetBtn = document.querySelector('.resetPassword');
var bookBtn = document.querySelector('#book-room');
var reviewBtn = document.getElementById('submitReview');
var deleteReviewBtn = document.querySelectorAll('.delete-icon');
var editReviewBtn = document.querySelectorAll('.edit-icon');
var saveReviewBtn = document.querySelectorAll('.save-icon'); //Login functionality
...
if (ResetBtn) {
  ResetBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var token = document.querySelector('.tokenH').dataset.token;
    var password = document.getElementById('password').value;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return (0, _stripe.bookRoom)(roomID);
...
if (reviewBtn) {
  reviewBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
      var room, user, rating, review;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              user = document.getElementById('reviewTextarea').dataset.user;
              rating = document.getElementById('number').value;
              review = document.getElementById('reviewTextarea').value;
              _context4.next = 7;
              return (0, _createReview.createReview)(review, rating, user, room);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 4;
                return (0, _createReview.deleteReview)(reviewId);
...
if (saveReviewBtn) {
  saveReviewBtn.forEach(function (btn) {
    btn.addEventListener('click', /*#__PURE__*/function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(e) {
        var reviewtoken, review, rating, data;
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                e.preventDefault();
                reviewtoken = e.target.dataset.reviewtoken;
                review = e.target.closest('.reviews-card').querySelector('.review-card__review').textContent;
                rating = e.target.closest('.reviews-card').querySelector('.review-number').textContent;
                data = {
                  rating: rating,
                  review: review
                };
                _context6.next = 7;
                return (0, _createReview.editReview)(reviewtoken, data);
...
if (editReviewBtn) {
  editReviewBtn.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.target.closest('.reviews-card').querySelector('.review-card__review').setAttribute('contenteditable', 'true');
      e.target.closest('.reviews-card').querySelector('.review-number').setAttribute('contenteditable', 'true'); // highlight

      e.target.closest('.reviews-card').querySelector('.review-card__review').style.outline = 'solid #777 2px';
      e.target.closest('.reviews-card').querySelector('.review-number').style.outline = 'solid #777 2px'; // show save icon button

      e.target.closest('.reviews-card').querySelector('.save-icon').style.display = 'block';
    });
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12015" + '/');
